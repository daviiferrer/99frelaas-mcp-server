...
3. Create a DNS entry for the webhook host and point it to the VPS, then create a GitHub webhook for `push` events targeting `https://<your-webhook-host>/webhooks/github`.
